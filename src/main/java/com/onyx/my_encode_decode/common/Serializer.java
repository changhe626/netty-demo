...
import com.onyx.my_protocol.BufferFactory;
...
public abstract class Serializer {
	 ...
	 * @return
	 */
	public ChannelBuffer write2LocalBuff(){
	 ...
	 * 写入目标buff
	 */
	public ChannelBuffer write2TargetBuff(ChannelBuffer buffer){
		writeBuffer = buffer;
		write();
		return writeBuffer;
	}
	...
	public Serializer writeObject(Object object) {
		if(object == null){
			...
			if (object instanceof Serializer) {
				...
				value.write2TargetBuff(writeBuffer);
				return this;
			}
